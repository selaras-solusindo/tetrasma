...
$tb_akun_lvl3_view = NULL; // Initialize page object first

class ctb_akun_lvl3_view extends ctb_akun_lvl3 {
	...
	// Page object name
	var $PageObjName = 'tb_akun_lvl3_view';
	...
	function __construct() {
		...
		if (@$_GET["akun_lvl3_id"] <> "") {
			$this->RecKey["akun_lvl3_id"] = $_GET["akun_lvl3_id"];
			$KeyUrl .= "&amp;akun_lvl3_id=" . urlencode($this->RecKey["akun_lvl3_id"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["akun_lvl3_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["akun_lvl3_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["akun_lvl3_id"] <> "") {
				...
				$this->RecKey["akun_lvl3_id"] = $this->akun_lvl3_id->QueryStringValue;
			} elseif (@$_POST["akun_lvl3_id"] <> "") {
				$this->akun_lvl3_id->setFormValue($_POST["akun_lvl3_id"]);
				$this->RecKey["akun_lvl3_id"] = $this->akun_lvl3_id->FormValue;
			} else {
				$sReturnUrl = "tb_akun_lvl3list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tb_akun_lvl3list.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tb_akun_lvl3list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_tb_akun_lvl3\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_tb_akun_lvl3',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.ftb_akun_lvl3view,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($tb_akun_lvl3_view)) $tb_akun_lvl3_view = new ctb_akun_lvl3_view();

// Page init
$tb_akun_lvl3_view->Page_Init();

// Page main
$tb_akun_lvl3_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tb_akun_lvl3_view->Page_Render();
?>
<?php include_once "header.php" ?>
<?php if ($tb_akun_lvl3->Export == "") { ?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "view";
var CurrentForm = ftb_akun_lvl3view = new ew_Form("ftb_akun_lvl3view", "view");

// Form_CustomValidate event
ftb_akun_lvl3view.Form_CustomValidate = 
...
ftb_akun_lvl3view.ValidateRequired = true;
<?php } else { ?>
ftb_akun_lvl3view.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftb_akun_lvl3view.Lists["x_akun_lvl1_id"] = {"LinkField":"x_akun_lvl1_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_akun_lvl1_nama","","",""],"ParentFields":[],"ChildFields":["x_akun_lvl2_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tb_akun_lvl1"};
ftb_akun_lvl3view.Lists["x_akun_lvl2_id"] = {"LinkField":"x_akun_lvl2_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_akun_lvl2_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tb_akun_lvl2"};
...
<?php if ($tb_akun_lvl3->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$tb_akun_lvl3_view->IsModal) { ?>
<?php if ($tb_akun_lvl3->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $tb_akun_lvl3_view->ExportOptions->Render("body") ?>
<?php
	foreach ($tb_akun_lvl3_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$tb_akun_lvl3_view->IsModal) { ?>
<?php if ($tb_akun_lvl3->Export == "") { ?>
...
<?php } ?>
<?php $tb_akun_lvl3_view->ShowPageHeader(); ?>
<?php
$tb_akun_lvl3_view->ShowMessage();
?>
<form name="ftb_akun_lvl3view" id="ftb_akun_lvl3view" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tb_akun_lvl3_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tb_akun_lvl3_view->Token ?>">
<?php } ?>
...
<?php if ($tb_akun_lvl3->akun_lvl1_id->Visible) { // akun_lvl1_id ?>
	<tr id="r_akun_lvl1_id">
		<td><span id="elh_tb_akun_lvl3_akun_lvl1_id"><?php echo $tb_akun_lvl3->akun_lvl1_id->FldCaption() ?></span></td>
		<td data-name="akun_lvl1_id"<?php echo $tb_akun_lvl3->akun_lvl1_id->CellAttributes() ?>>
<span id="el_tb_akun_lvl3_akun_lvl1_id">
<span<?php echo $tb_akun_lvl3->akun_lvl1_id->ViewAttributes() ?>>
<?php echo $tb_akun_lvl3->akun_lvl1_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tb_akun_lvl3->akun_lvl2_id->Visible) { // akun_lvl2_id ?>
	<tr id="r_akun_lvl2_id">
		<td><span id="elh_tb_akun_lvl3_akun_lvl2_id"><?php echo $tb_akun_lvl3->akun_lvl2_id->FldCaption() ?></span></td>
		<td data-name="akun_lvl2_id"<?php echo $tb_akun_lvl3->akun_lvl2_id->CellAttributes() ?>>
<span id="el_tb_akun_lvl3_akun_lvl2_id">
<span<?php echo $tb_akun_lvl3->akun_lvl2_id->ViewAttributes() ?>>
<?php echo $tb_akun_lvl3->akun_lvl2_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tb_akun_lvl3->akun_lvl3_nama->Visible) { // akun_lvl3_nama ?>
	<tr id="r_akun_lvl3_nama">
		<td><span id="elh_tb_akun_lvl3_akun_lvl3_nama"><?php echo $tb_akun_lvl3->akun_lvl3_nama->FldCaption() ?></span></td>
		<td data-name="akun_lvl3_nama"<?php echo $tb_akun_lvl3->akun_lvl3_nama->CellAttributes() ?>>
<span id="el_tb_akun_lvl3_akun_lvl3_nama">
<span<?php echo $tb_akun_lvl3->akun_lvl3_nama->ViewAttributes() ?>>
<?php echo $tb_akun_lvl3->akun_lvl3_nama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($tb_akun_lvl3->Export == "") { ?>
<script type="text/javascript">
ftb_akun_lvl3view.Init();
</script>
<?php } ?>
<?php
$tb_akun_lvl3_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tb_akun_lvl3->Export == "") { ?>
...
<?php
$tb_akun_lvl3_view->Page_Terminate();
?>
