...
$tb_detail_grid = NULL; // Initialize page object first

class ctb_detail_grid extends ctb_detail {
	...
	// Page object name
	var $PageObjName = 'tb_detail_grid';

	// Grid form hidden field names
	var $FormName = 'ftb_detailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["tb_detail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "tb_jurnal") {
			...
			if ($GLOBALS["tb_jurnal"]->EventCancelled) $this->EventCancelled = TRUE;
		}
