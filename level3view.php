...
$level3_view = NULL; // Initialize page object first

class clevel3_view extends clevel3 {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["level3_id"] <> "") {
				...
				$sReturnUrl = "level3list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "level3list.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "level3list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_level3\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_level3',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.flevel3view,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($level3_view)) $level3_view = new clevel3_view();

// Page init
$level3_view->Page_Init();

// Page main
$level3_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$level3_view->Page_Render();
?>
...
var CurrentForm = flevel3view = new ew_Form("flevel3view", "view");

// Form_CustomValidate event
flevel3view.Form_CustomValidate = 
...
flevel3view.ValidateRequired = true;
<?php } else { ?>
flevel3view.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
flevel3view.Lists["x_level1_id"] = {"LinkField":"x_level1_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level1_no","x_level1_nama","",""],"ParentFields":[],"ChildFields":["x_level2_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"level1"};
flevel3view.Lists["x_level2_id"] = {"LinkField":"x_level2_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level2_no","x_level2_nama","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"level2"};
...
<?php if ($level3->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$level3_view->IsModal) { ?>
<?php if ($level3->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $level3_view->ExportOptions->Render("body") ?>
<?php
	foreach ($level3_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$level3_view->IsModal) { ?>
<?php if ($level3->Export == "") { ?>
...
<?php } ?>
<?php $level3_view->ShowPageHeader(); ?>
<?php
$level3_view->ShowMessage();
?>
<form name="flevel3view" id="flevel3view" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($level3_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $level3_view->Token ?>">
<?php } ?>
...
<?php if ($level3->level1_id->Visible) { // level1_id ?>
	<tr id="r_level1_id">
		<td><span id="elh_level3_level1_id"><?php echo $level3->level1_id->FldCaption() ?></span></td>
...
<?php echo $level3->level1_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($level3->level2_id->Visible) { // level2_id ?>
	<tr id="r_level2_id">
		<td><span id="elh_level3_level2_id"><?php echo $level3->level2_id->FldCaption() ?></span></td>
...
<?php echo $level3->level2_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($level3->level3_no->Visible) { // level3_no ?>
	<tr id="r_level3_no">
		<td><span id="elh_level3_level3_no"><?php echo $level3->level3_no->FldCaption() ?></span></td>
...
<?php echo $level3->level3_no->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($level3->level3_nama->Visible) { // level3_nama ?>
	<tr id="r_level3_nama">
		<td><span id="elh_level3_level3_nama"><?php echo $level3->level3_nama->FldCaption() ?></span></td>
...
<?php echo $level3->level3_nama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
