...
$tb_detailm_view = NULL; // Initialize page object first

class ctb_detailm_view extends ctb_detailm {
	...
	// Page object name
	var $PageObjName = 'tb_detailm_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["detailm_id"] <> "") {
				...
				$sReturnUrl = "tb_detailmlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tb_detailmlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tb_detailmlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($tb_detailm_view)) $tb_detailm_view = new ctb_detailm_view();

// Page init
$tb_detailm_view->Page_Init();

// Page main
$tb_detailm_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tb_detailm_view->Page_Render();
?>
...
var CurrentForm = ftb_detailmview = new ew_Form("ftb_detailmview", "view");

// Form_CustomValidate event
ftb_detailmview.Form_CustomValidate = 
...
ftb_detailmview.ValidateRequired = true;
<?php } else { ?>
ftb_detailmview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($tb_detailm->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$tb_detailm_view->IsModal) { ?>
<?php if ($tb_detailm->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $tb_detailm_view->ExportOptions->Render("body") ?>
<?php
	foreach ($tb_detailm_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$tb_detailm_view->IsModal) { ?>
<?php if ($tb_detailm->Export == "") { ?>
...
<?php } ?>
<?php $tb_detailm_view->ShowPageHeader(); ?>
<?php
$tb_detailm_view->ShowMessage();
?>
<form name="ftb_detailmview" id="ftb_detailmview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tb_detailm_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tb_detailm_view->Token ?>">
<?php } ?>
...
<?php if ($tb_detailm->nilaim_debet->Visible) { // nilaim_debet ?>
	<tr id="r_nilaim_debet">
		<td><span id="elh_tb_detailm_nilaim_debet"><?php echo $tb_detailm->nilaim_debet->FldCaption() ?></span></td>
...
<?php if ($tb_detailm->nilaim_kredit->Visible) { // nilaim_kredit ?>
	<tr id="r_nilaim_kredit">
		<td><span id="elh_tb_detailm_nilaim_kredit"><?php echo $tb_detailm->nilaim_kredit->FldCaption() ?></span></td>
...
<?php echo $tb_detailm->nilaim_kredit->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($tb_detailm->Export == "") { ?>
<script type="text/javascript">
ftb_detailmview.Init();
</script>
<?php } ?>
<?php
$tb_detailm_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tb_detailm->Export == "") { ?>
...
<?php
$tb_detailm_view->Page_Terminate();
?>
