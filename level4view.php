...
$level4_view = NULL; // Initialize page object first

class clevel4_view extends clevel4 {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["level4_id"] <> "") {
				...
				$sReturnUrl = "level4list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "level4list.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "level4list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_level4\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_level4',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.flevel4view,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($level4_view)) $level4_view = new clevel4_view();

// Page init
$level4_view->Page_Init();

// Page main
$level4_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$level4_view->Page_Render();
?>
...
var CurrentForm = flevel4view = new ew_Form("flevel4view", "view");

// Form_CustomValidate event
flevel4view.Form_CustomValidate = 
...
flevel4view.ValidateRequired = true;
<?php } else { ?>
flevel4view.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
flevel4view.Lists["x_level1_id"] = {"LinkField":"x_level1_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level1_nama","","",""],"ParentFields":[],"ChildFields":["x_level2_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"level1"};
flevel4view.Lists["x_level2_id"] = {"LinkField":"x_level2_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level2_nama","","",""],"ParentFields":[],"ChildFields":["x_level3_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"level2"};
flevel4view.Lists["x_level3_id"] = {"LinkField":"x_level3_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level3_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"level3"};
...
<?php if ($level4->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$level4_view->IsModal) { ?>
<?php if ($level4->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $level4_view->ExportOptions->Render("body") ?>
<?php
	foreach ($level4_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$level4_view->IsModal) { ?>
<?php if ($level4->Export == "") { ?>
...
<?php } ?>
<?php $level4_view->ShowPageHeader(); ?>
<?php
$level4_view->ShowMessage();
?>
<form name="flevel4view" id="flevel4view" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($level4_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $level4_view->Token ?>">
<?php } ?>
...
<?php if ($level4->level1_id->Visible) { // level1_id ?>
	<tr id="r_level1_id">
		<td><span id="elh_level4_level1_id"><?php echo $level4->level1_id->FldCaption() ?></span></td>
...
<?php echo $level4->level1_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($level4->level2_id->Visible) { // level2_id ?>
	<tr id="r_level2_id">
		<td><span id="elh_level4_level2_id"><?php echo $level4->level2_id->FldCaption() ?></span></td>
...
<?php echo $level4->level2_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($level4->level3_id->Visible) { // level3_id ?>
	<tr id="r_level3_id">
		<td><span id="elh_level4_level3_id"><?php echo $level4->level3_id->FldCaption() ?></span></td>
...
<?php echo $level4->level3_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($level4->level4_no->Visible) { // level4_no ?>
	<tr id="r_level4_no">
		<td><span id="elh_level4_level4_no"><?php echo $level4->level4_no->FldCaption() ?></span></td>
...
<?php echo $level4->level4_no->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($level4->level4_nama->Visible) { // level4_nama ?>
	<tr id="r_level4_nama">
		<td><span id="elh_level4_level4_nama"><?php echo $level4->level4_nama->FldCaption() ?></span></td>
...
<?php echo $level4->level4_nama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
