...
$tb_level3_edit = NULL; // Initialize page object first

class ctb_level3_edit extends ctb_level3 {
	...
	// Page object name
	var $PageObjName = 'tb_level3_edit';
	...
	function Page_Main() {
		...
		if ($this->level3_id->CurrentValue == "") {
			$this->Page_Terminate("tb_level3list.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($tb_level3_edit)) $tb_level3_edit = new ctb_level3_edit();

// Page init
$tb_level3_edit->Page_Init();

// Page main
$tb_level3_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tb_level3_edit->Page_Render();
?>
...
var CurrentForm = ftb_level3edit = new ew_Form("ftb_level3edit", "edit");

// Validate form
ftb_level3edit.Validate = function() {
...
ftb_level3edit.Form_CustomValidate = 
...
ftb_level3edit.ValidateRequired = true;
<?php } else { ?>
ftb_level3edit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftb_level3edit.Lists["x_level1_id"] = {"LinkField":"x_level1_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level1_no","x_level1_nama","",""],"ParentFields":[],"ChildFields":["x_level2_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tb_level1"};
ftb_level3edit.Lists["x_level2_id"] = {"LinkField":"x_level2_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_level2_no","x_level2_nama","",""],"ParentFields":["x_level1_id"],"ChildFields":[],"FilterFields":["x_level1_id"],"Options":[],"Template":"","LinkTable":"tb_level2"};
...
<?php } ?>
<?php $tb_level3_edit->ShowPageHeader(); ?>
<?php
$tb_level3_edit->ShowMessage();
?>
<form name="ftb_level3edit" id="ftb_level3edit" class="<?php echo $tb_level3_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tb_level3_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tb_level3_edit->Token ?>">
<?php } ?>
...
<?php $tb_level3->level1_id->EditAttrs["onchange"] = "ew_UpdateOpt.call(this); " . @$tb_level3->level1_id->EditAttrs["onchange"]; ?>
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_level1_id"><?php echo (strval($tb_level3->level1_id->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $tb_level3->level1_id->ViewValue); ?></span>
</span>
<button type="button" title="<?php echo ew_HtmlEncode(str_replace("%s", ew_RemoveHtml($tb_level3->level1_id->FldCaption()), $Language->Phrase("LookupLink", TRUE))) ?>" onclick="ew_ModalLookupShow({lnk:this,el:'x_level1_id',m:0,n:10});" class="ewLookupBtn btn btn-default btn-sm"><span class="glyphicon glyphicon-search ewIcon"></span></button>
<input type="hidden" data-table="tb_level3" data-field="x_level1_id" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $tb_level3->level1_id->DisplayValueSeparatorAttribute() ?>" name="x_level1_id" id="x_level1_id" value="<?php echo $tb_level3->level1_id->CurrentValue ?>"<?php echo $tb_level3->level1_id->EditAttributes() ?>>
<input type="hidden" name="s_x_level1_id" id="s_x_level1_id" value="<?php echo $tb_level3->level1_id->LookupFilterQuery() ?>">
</span>
...
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_level2_id"><?php echo (strval($tb_level3->level2_id->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $tb_level3->level2_id->ViewValue); ?></span>
</span>
<button type="button" title="<?php echo ew_HtmlEncode(str_replace("%s", ew_RemoveHtml($tb_level3->level2_id->FldCaption()), $Language->Phrase("LookupLink", TRUE))) ?>" onclick="ew_ModalLookupShow({lnk:this,el:'x_level2_id',m:0,n:10});" class="ewLookupBtn btn btn-default btn-sm"><span class="glyphicon glyphicon-search ewIcon"></span></button>
<input type="hidden" data-table="tb_level3" data-field="x_level2_id" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $tb_level3->level2_id->DisplayValueSeparatorAttribute() ?>" name="x_level2_id" id="x_level2_id" value="<?php echo $tb_level3->level2_id->CurrentValue ?>"<?php echo $tb_level3->level2_id->EditAttributes() ?>>
<input type="hidden" name="s_x_level2_id" id="s_x_level2_id" value="<?php echo $tb_level3->level2_id->LookupFilterQuery() ?>">
</span>
...
<input type="hidden" data-table="tb_level3" data-field="x_level3_id" name="x_level3_id" id="x_level3_id" value="<?php echo ew_HtmlEncode($tb_level3->level3_id->CurrentValue) ?>">
<?php if (!$tb_level3_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tb_level3_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
