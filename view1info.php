...
class cview1 extends cTable {
	...
	function __construct() {
		...
		// kode_akun
		$this->kode_akun = new cField('view1', 'view1', 'x_kode_akun', 'kode_akun', '`kode_akun`', '`kode_akun`', 200, -1, FALSE, '`kode_akun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode_akun->Sortable = TRUE; // Allow sort
		$this->fields['kode_akun'] = &$this->kode_akun;

		// nama_akun
		$this->nama_akun = new cField('view1', 'view1', 'x_nama_akun', 'nama_akun', '`nama_akun`', '`nama_akun`', 200, -1, FALSE, '`nama_akun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->kode_akun->PlaceHolder = ew_RemoveHtml($this->kode_akun->FldCaption());
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					if ($this->kode_akun->Exportable) $Doc->ExportCaption($this->kode_akun);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						if ($this->kode_akun->Exportable) $Doc->ExportField($this->kode_akun);
