...
$tb_akun_lvl4_view = NULL; // Initialize page object first

class ctb_akun_lvl4_view extends ctb_akun_lvl4 {
	...
	// Page object name
	var $PageObjName = 'tb_akun_lvl4_view';
	...
	function __construct() {
		...
		if (@$_GET["akun_lvl4_id"] <> "") {
			$this->RecKey["akun_lvl4_id"] = $_GET["akun_lvl4_id"];
			$KeyUrl .= "&amp;akun_lvl4_id=" . urlencode($this->RecKey["akun_lvl4_id"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["akun_lvl4_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["akun_lvl4_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["akun_lvl4_id"] <> "") {
				...
				$this->RecKey["akun_lvl4_id"] = $this->akun_lvl4_id->QueryStringValue;
			} elseif (@$_POST["akun_lvl4_id"] <> "") {
				$this->akun_lvl4_id->setFormValue($_POST["akun_lvl4_id"]);
				$this->RecKey["akun_lvl4_id"] = $this->akun_lvl4_id->FormValue;
			} else {
				$sReturnUrl = "tb_akun_lvl4list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tb_akun_lvl4list.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tb_akun_lvl4list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($tb_akun_lvl4_view)) $tb_akun_lvl4_view = new ctb_akun_lvl4_view();

// Page init
$tb_akun_lvl4_view->Page_Init();

// Page main
$tb_akun_lvl4_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tb_akun_lvl4_view->Page_Render();
?>
...
var CurrentForm = ftb_akun_lvl4view = new ew_Form("ftb_akun_lvl4view", "view");

// Form_CustomValidate event
ftb_akun_lvl4view.Form_CustomValidate = 
...
ftb_akun_lvl4view.ValidateRequired = true;
<?php } else { ?>
ftb_akun_lvl4view.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftb_akun_lvl4view.Lists["x_akun_lvl1_id"] = {"LinkField":"x_akun_lvl1_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_akun_lvl1_nama","","",""],"ParentFields":[],"ChildFields":["x_akun_lvl2_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tb_akun_lvl1"};
ftb_akun_lvl4view.Lists["x_akun_lvl2_id"] = {"LinkField":"x_akun_lvl2_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_akun_lvl2_nama","","",""],"ParentFields":[],"ChildFields":["x_akun_lvl3_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tb_akun_lvl2"};
ftb_akun_lvl4view.Lists["x_akun_lvl3_id"] = {"LinkField":"x_akun_lvl3_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_akun_lvl3_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tb_akun_lvl3"};
...
<?php if ($tb_akun_lvl4->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$tb_akun_lvl4_view->IsModal) { ?>
<?php if ($tb_akun_lvl4->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $tb_akun_lvl4_view->ExportOptions->Render("body") ?>
<?php
	foreach ($tb_akun_lvl4_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$tb_akun_lvl4_view->IsModal) { ?>
<?php if ($tb_akun_lvl4->Export == "") { ?>
...
<?php } ?>
<?php $tb_akun_lvl4_view->ShowPageHeader(); ?>
<?php
$tb_akun_lvl4_view->ShowMessage();
?>
<form name="ftb_akun_lvl4view" id="ftb_akun_lvl4view" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tb_akun_lvl4_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tb_akun_lvl4_view->Token ?>">
<?php } ?>
...
<?php if ($tb_akun_lvl4->akun_lvl4_id->Visible) { // akun_lvl4_id ?>
	<tr id="r_akun_lvl4_id">
		<td><span id="elh_tb_akun_lvl4_akun_lvl4_id"><?php echo $tb_akun_lvl4->akun_lvl4_id->FldCaption() ?></span></td>
...
<?php echo $tb_akun_lvl4->akun_lvl4_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tb_akun_lvl4->akun_lvl1_id->Visible) { // akun_lvl1_id ?>
	<tr id="r_akun_lvl1_id">
		<td><span id="elh_tb_akun_lvl4_akun_lvl1_id"><?php echo $tb_akun_lvl4->akun_lvl1_id->FldCaption() ?></span></td>
...
<?php echo $tb_akun_lvl4->akun_lvl1_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tb_akun_lvl4->akun_lvl2_id->Visible) { // akun_lvl2_id ?>
	<tr id="r_akun_lvl2_id">
		<td><span id="elh_tb_akun_lvl4_akun_lvl2_id"><?php echo $tb_akun_lvl4->akun_lvl2_id->FldCaption() ?></span></td>
...
<?php echo $tb_akun_lvl4->akun_lvl2_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tb_akun_lvl4->akun_lvl3_id->Visible) { // akun_lvl3_id ?>
	<tr id="r_akun_lvl3_id">
		<td><span id="elh_tb_akun_lvl4_akun_lvl3_id"><?php echo $tb_akun_lvl4->akun_lvl3_id->FldCaption() ?></span></td>
...
<?php echo $tb_akun_lvl4->akun_lvl3_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tb_akun_lvl4->akun_lvl4_nama->Visible) { // akun_lvl4_nama ?>
	<tr id="r_akun_lvl4_nama">
		<td><span id="elh_tb_akun_lvl4_akun_lvl4_nama"><?php echo $tb_akun_lvl4->akun_lvl4_nama->FldCaption() ?></span></td>
...
<?php echo $tb_akun_lvl4->akun_lvl4_nama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($tb_akun_lvl4->Export == "") { ?>
<script type="text/javascript">
ftb_akun_lvl4view.Init();
</script>
<?php } ?>
<?php
$tb_akun_lvl4_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tb_akun_lvl4->Export == "") { ?>
...
<?php
$tb_akun_lvl4_view->Page_Terminate();
?>
