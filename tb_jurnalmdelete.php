...
$tb_jurnalm_delete = NULL; // Initialize page object first

class ctb_jurnalm_delete extends ctb_jurnalm {
	...
	// Page object name
	var $PageObjName = 'tb_jurnalm_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("tb_jurnalmlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in tb_jurnalm class, tb_jurnalminfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("tb_jurnalmlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($tb_jurnalm_delete)) $tb_jurnalm_delete = new ctb_jurnalm_delete();

// Page init
$tb_jurnalm_delete->Page_Init();

// Page main
$tb_jurnalm_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tb_jurnalm_delete->Page_Render();
?>
...
var CurrentForm = ftb_jurnalmdelete = new ew_Form("ftb_jurnalmdelete", "delete");

// Form_CustomValidate event
ftb_jurnalmdelete.Form_CustomValidate = 
...
ftb_jurnalmdelete.ValidateRequired = true;
<?php } else { ?>
ftb_jurnalmdelete.ValidateRequired = false; 
<?php } ?>
...
<?php $tb_jurnalm_delete->ShowPageHeader(); ?>
<?php
$tb_jurnalm_delete->ShowMessage();
?>
<form name="ftb_jurnalmdelete" id="ftb_jurnalmdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tb_jurnalm_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tb_jurnalm_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tb_jurnalm">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($tb_jurnalm_delete->RecKeys as $key) { ?>
...
<?php if ($tb_jurnalm->jurnalm_id->Visible) { // jurnalm_id ?>
		<th><span id="elh_tb_jurnalm_jurnalm_id" class="tb_jurnalm_jurnalm_id"><?php echo $tb_jurnalm->jurnalm_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($tb_jurnalm->no_buktim->Visible) { // no_buktim ?>
		<th><span id="elh_tb_jurnalm_no_buktim" class="tb_jurnalm_no_buktim"><?php echo $tb_jurnalm->no_buktim->FldCaption() ?></span></th>
<?php } ?>
<?php if ($tb_jurnalm->tglm->Visible) { // tglm ?>
		<th><span id="elh_tb_jurnalm_tglm" class="tb_jurnalm_tglm"><?php echo $tb_jurnalm->tglm->FldCaption() ?></span></th>
<?php } ?>
<?php if ($tb_jurnalm->ketm->Visible) { // ketm ?>
		<th><span id="elh_tb_jurnalm_ketm" class="tb_jurnalm_ketm"><?php echo $tb_jurnalm->ketm->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$tb_jurnalm_delete->RecCnt = 0;
$i = 0;
while (!$tb_jurnalm_delete->Recordset->EOF) {
	$tb_jurnalm_delete->RecCnt++;
	$tb_jurnalm_delete->RowCnt++;

	// Set row properties
	$tb_jurnalm->ResetAttrs();
	$tb_jurnalm->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$tb_jurnalm_delete->LoadRowValues($tb_jurnalm_delete->Recordset);

	// Render row
	$tb_jurnalm_delete->RenderRow();
?>
	<tr<?php echo $tb_jurnalm->RowAttributes() ?>>
<?php if ($tb_jurnalm->jurnalm_id->Visible) { // jurnalm_id ?>
		<td<?php echo $tb_jurnalm->jurnalm_id->CellAttributes() ?>>
<span id="el<?php echo $tb_jurnalm_delete->RowCnt ?>_tb_jurnalm_jurnalm_id" class="tb_jurnalm_jurnalm_id">
...
<span id="el<?php echo $tb_jurnalm_delete->RowCnt ?>_tb_jurnalm_no_buktim" class="tb_jurnalm_no_buktim">
...
<span id="el<?php echo $tb_jurnalm_delete->RowCnt ?>_tb_jurnalm_tglm" class="tb_jurnalm_tglm">
...
<span id="el<?php echo $tb_jurnalm_delete->RowCnt ?>_tb_jurnalm_ketm" class="tb_jurnalm_ketm">
...
<?php
	$tb_jurnalm_delete->Recordset->MoveNext();
}
$tb_jurnalm_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tb_jurnalm_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ftb_jurnalmdelete.Init();
</script>
<?php
$tb_jurnalm_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tb_jurnalm_delete->Page_Terminate();
?>
