...
$tb_akun_lvl2_edit = NULL; // Initialize page object first

class ctb_akun_lvl2_edit extends ctb_akun_lvl2 {
	...
	// Page object name
	var $PageObjName = 'tb_akun_lvl2_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->akun_lvl2_id->CurrentValue == "") {
			$this->Page_Terminate("tb_akun_lvl2list.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// akun_lvl2_nama
			$this->akun_lvl2_nama->SetDbValueDef($rsnew, $this->akun_lvl2_nama->CurrentValue, "", $this->akun_lvl2_nama->ReadOnly);
...
// Create page object
if (!isset($tb_akun_lvl2_edit)) $tb_akun_lvl2_edit = new ctb_akun_lvl2_edit();

// Page init
$tb_akun_lvl2_edit->Page_Init();

// Page main
$tb_akun_lvl2_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tb_akun_lvl2_edit->Page_Render();
?>
...
var CurrentForm = ftb_akun_lvl2edit = new ew_Form("ftb_akun_lvl2edit", "edit");

// Validate form
ftb_akun_lvl2edit.Validate = function() {
...
ftb_akun_lvl2edit.Form_CustomValidate = 
...
ftb_akun_lvl2edit.ValidateRequired = true;
<?php } else { ?>
ftb_akun_lvl2edit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftb_akun_lvl2edit.Lists["x_akun_lvl1_id"] = {"LinkField":"x_akun_lvl1_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_akun_lvl1_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tb_akun_lvl1"};
...
<?php if (!$tb_akun_lvl2_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $tb_akun_lvl2_edit->ShowPageHeader(); ?>
<?php
$tb_akun_lvl2_edit->ShowMessage();
?>
<form name="ftb_akun_lvl2edit" id="ftb_akun_lvl2edit" class="<?php echo $tb_akun_lvl2_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tb_akun_lvl2_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tb_akun_lvl2_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="tb_akun_lvl2" data-field="x_akun_lvl2_id" name="x_akun_lvl2_id" id="x_akun_lvl2_id" value="<?php echo ew_HtmlEncode($tb_akun_lvl2->akun_lvl2_id->CurrentValue) ?>">
<?php if (!$tb_akun_lvl2_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tb_akun_lvl2_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ftb_akun_lvl2edit.Init();
</script>
<?php
$tb_akun_lvl2_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tb_akun_lvl2_edit->Page_Terminate();
?>
