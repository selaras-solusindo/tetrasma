...
class ctbl_anggota extends cTable {
	...
	function __construct() {
		...
		// tgl_masuk
		$this->tgl_masuk = new cField('tbl_anggota', 'tbl_anggota', 'x_tgl_masuk', 'tgl_masuk', '`tgl_masuk`', ew_CastDateFieldForLike('`tgl_masuk`', 0, "DB"), 133, 0, FALSE, '`tgl_masuk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
