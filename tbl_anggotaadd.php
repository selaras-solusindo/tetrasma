...
$tbl_anggota_add = NULL; // Initialize page object first

class ctbl_anggota_add extends ctbl_anggota {
	...
	// Page object name
	var $PageObjName = 'tbl_anggota_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "tbl_anggotaview.php")
...
// Create page object
if (!isset($tbl_anggota_add)) $tbl_anggota_add = new ctbl_anggota_add();

// Page init
$tbl_anggota_add->Page_Init();

// Page main
$tbl_anggota_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbl_anggota_add->Page_Render();
?>
...
var CurrentForm = ftbl_anggotaadd = new ew_Form("ftbl_anggotaadd", "add");

// Validate form
ftbl_anggotaadd.Validate = function() {
...
ftbl_anggotaadd.Form_CustomValidate = 
...
ftbl_anggotaadd.ValidateRequired = true;
<?php } else { ?>
ftbl_anggotaadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$tbl_anggota_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $tbl_anggota_add->ShowPageHeader(); ?>
<?php
$tbl_anggota_add->ShowMessage();
?>
<form name="ftbl_anggotaadd" id="ftbl_anggotaadd" class="<?php echo $tbl_anggota_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tbl_anggota_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tbl_anggota_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tbl_anggota_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ftbl_anggotaadd.Init();
</script>
<?php
$tbl_anggota_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tbl_anggota_add->Page_Terminate();
?>
