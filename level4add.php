...
<script type="text/javascript">
flevel4add.CreateAutoSuggest({"id":"x_level1_id","forceSelect":true});
</script>
...
<script type="text/javascript">
flevel4add.CreateAutoSuggest({"id":"x_level2_id","forceSelect":true});
</script>
...
<script type="text/javascript">
flevel4add.CreateAutoSuggest({"id":"x_level3_id","forceSelect":true});
</script>
