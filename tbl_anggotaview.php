...
$tbl_anggota_view = NULL; // Initialize page object first

class ctbl_anggota_view extends ctbl_anggota {
	...
	// Page object name
	var $PageObjName = 'tbl_anggota_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["anggota_id"] <> "") {
				...
				$sReturnUrl = "tbl_anggotalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tbl_anggotalist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tbl_anggotalist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($tbl_anggota_view)) $tbl_anggota_view = new ctbl_anggota_view();

// Page init
$tbl_anggota_view->Page_Init();

// Page main
$tbl_anggota_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbl_anggota_view->Page_Render();
?>
...
var CurrentForm = ftbl_anggotaview = new ew_Form("ftbl_anggotaview", "view");

// Form_CustomValidate event
ftbl_anggotaview.Form_CustomValidate = 
...
ftbl_anggotaview.ValidateRequired = true;
<?php } else { ?>
ftbl_anggotaview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($tbl_anggota->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$tbl_anggota_view->IsModal) { ?>
<?php if ($tbl_anggota->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $tbl_anggota_view->ExportOptions->Render("body") ?>
<?php
	foreach ($tbl_anggota_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$tbl_anggota_view->IsModal) { ?>
<?php if ($tbl_anggota->Export == "") { ?>
...
<?php } ?>
<?php $tbl_anggota_view->ShowPageHeader(); ?>
<?php
$tbl_anggota_view->ShowMessage();
?>
<form name="ftbl_anggotaview" id="ftbl_anggotaview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tbl_anggota_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tbl_anggota_view->Token ?>">
<?php } ?>
...
<?php if ($tbl_anggota->no_anggota->Visible) { // no_anggota ?>
	<tr id="r_no_anggota">
		<td><span id="elh_tbl_anggota_no_anggota"><?php echo $tbl_anggota->no_anggota->FldCaption() ?></span></td>
...
<?php echo $tbl_anggota->no_anggota->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_anggota->nama->Visible) { // nama ?>
	<tr id="r_nama">
		<td><span id="elh_tbl_anggota_nama"><?php echo $tbl_anggota->nama->FldCaption() ?></span></td>
...
<?php echo $tbl_anggota->nama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_anggota->tgl_masuk->Visible) { // tgl_masuk ?>
	<tr id="r_tgl_masuk">
		<td><span id="elh_tbl_anggota_tgl_masuk"><?php echo $tbl_anggota->tgl_masuk->FldCaption() ?></span></td>
...
<?php echo $tbl_anggota->tgl_masuk->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_anggota->alamat->Visible) { // alamat ?>
	<tr id="r_alamat">
		<td><span id="elh_tbl_anggota_alamat"><?php echo $tbl_anggota->alamat->FldCaption() ?></span></td>
...
<?php echo $tbl_anggota->alamat->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_anggota->kota->Visible) { // kota ?>
	<tr id="r_kota">
		<td><span id="elh_tbl_anggota_kota"><?php echo $tbl_anggota->kota->FldCaption() ?></span></td>
...
<?php echo $tbl_anggota->kota->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_anggota->no_telp->Visible) { // no_telp ?>
	<tr id="r_no_telp">
		<td><span id="elh_tbl_anggota_no_telp"><?php echo $tbl_anggota->no_telp->FldCaption() ?></span></td>
...
<?php echo $tbl_anggota->no_telp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_anggota->pekerjaan->Visible) { // pekerjaan ?>
	<tr id="r_pekerjaan">
		<td><span id="elh_tbl_anggota_pekerjaan"><?php echo $tbl_anggota->pekerjaan->FldCaption() ?></span></td>
...
<?php echo $tbl_anggota->pekerjaan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_anggota->jns_pengenal->Visible) { // jns_pengenal ?>
	<tr id="r_jns_pengenal">
		<td><span id="elh_tbl_anggota_jns_pengenal"><?php echo $tbl_anggota->jns_pengenal->FldCaption() ?></span></td>
...
<?php echo $tbl_anggota->jns_pengenal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_anggota->no_pengenal->Visible) { // no_pengenal ?>
	<tr id="r_no_pengenal">
		<td><span id="elh_tbl_anggota_no_pengenal"><?php echo $tbl_anggota->no_pengenal->FldCaption() ?></span></td>
...
<?php echo $tbl_anggota->no_pengenal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($tbl_anggota->Export == "") { ?>
<script type="text/javascript">
ftbl_anggotaview.Init();
</script>
<?php } ?>
<?php
$tbl_anggota_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tbl_anggota->Export == "") { ?>
...
<?php
$tbl_anggota_view->Page_Terminate();
?>
