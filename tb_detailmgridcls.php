...
$tb_detailm_grid = NULL; // Initialize page object first

class ctb_detailm_grid extends ctb_detailm {
	...
	// Page object name
	var $PageObjName = 'tb_detailm_grid';

	// Grid form hidden field names
	var $FormName = 'ftb_detailmgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["tb_detailm"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_akunm_id_debet") && $objForm->HasValue("o_akunm_id_debet") && $this->akunm_id_debet->CurrentValue <> $this->akunm_id_debet->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_nilaim_debet") && $objForm->HasValue("o_nilaim_debet") && $this->nilaim_debet->CurrentValue <> $this->nilaim_debet->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_akunm_id_kredit") && $objForm->HasValue("o_akunm_id_kredit") && $this->akunm_id_kredit->CurrentValue <> $this->akunm_id_kredit->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->akunm_id_debet->setOldValue($objForm->GetValue("o_akunm_id_debet"));
		...
		$this->akunm_id_kredit->setOldValue($objForm->GetValue("o_akunm_id_kredit"));
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "tb_jurnalm") {
			...
			if ($GLOBALS["tb_jurnalm"]->EventCancelled) $this->EventCancelled = TRUE;
		}
