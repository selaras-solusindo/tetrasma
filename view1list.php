...
class cview1_list extends cview1 {
	...
	function GetFilterList() {
		...
		// Initialize
		$sFilterList = "";
		$sFilterList = ew_Concat($sFilterList, $this->kode_akun->AdvancedSearch->ToJSON(), ","); // Field kode_akun
	...
	function BasicSearchSQL($arKeywords, $type) {
		$sWhere = "";
		$this->BuildBasicSearchSQL($sWhere, $this->kode_akun, $arKeywords, $type);
...
?>
<?php if ($view1->kode_akun->Visible) { // kode_akun ?>
	<?php if ($view1->SortUrl($view1->kode_akun) == "") { ?>
		<th data-name="kode_akun"><div id="elh_view1_kode_akun" class="view1_kode_akun"><div class="ewTableHeaderCaption"><?php echo $view1->kode_akun->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="kode_akun"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->kode_akun) ?>',1);"><div id="elh_view1_kode_akun" class="view1_kode_akun">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->kode_akun->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->kode_akun->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->kode_akun->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($view1->nama_akun->Visible) { // nama_akun ?>
	<?php if ($view1->SortUrl($view1->nama_akun) == "") { ?>
		<th data-name="nama_akun"><div id="elh_view1_nama_akun" class="view1_nama_akun"><div class="ewTableHeaderCaption"><?php echo $view1->nama_akun->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nama_akun"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $view1->SortUrl($view1->nama_akun) ?>',1);"><div id="elh_view1_nama_akun" class="view1_nama_akun">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $view1->nama_akun->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($view1->nama_akun->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($view1->nama_akun->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($view1->kode_akun->Visible) { // kode_akun ?>
		<td data-name="kode_akun"<?php echo $view1->kode_akun->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_kode_akun" class="view1_kode_akun">
<span<?php echo $view1->kode_akun->ViewAttributes() ?>>
<?php echo $view1->kode_akun->ListViewValue() ?></span>
</span>
<a id="<?php echo $view1_list->PageObjName . "_row_" . $view1_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($view1->nama_akun->Visible) { // nama_akun ?>
		<td data-name="nama_akun"<?php echo $view1->nama_akun->CellAttributes() ?>>
<span id="el<?php echo $view1_list->RowCnt ?>_view1_nama_akun" class="view1_nama_akun">
<span<?php echo $view1->nama_akun->ViewAttributes() ?>>
<?php echo $view1->nama_akun->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
