...
$RootMenu->AddMenuItem(42, "mmci_Jurnal", $Language->MenuPhrase("42", "MenuText"), "", -1, "", TRUE, FALSE, TRUE);
$RootMenu->AddMenuItem(20, "mmi_tb_jurnal", $Language->MenuPhrase("20", "MenuText"), "tb_jurnallist.php", 42, "", AllowListMenu('{D8E5AA29-C8A1-46A6-8DFF-08A223163C5D}tb_jurnal'), FALSE, FALSE);
$RootMenu->AddMenuItem(27, "mmi_tb_jurnalm", $Language->MenuPhrase("27", "MenuText"), "tb_jurnalmlist.php", 42, "", AllowListMenu('{D8E5AA29-C8A1-46A6-8DFF-08A223163C5D}tb_jurnalm'), FALSE, FALSE);
