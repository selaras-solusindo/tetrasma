...
$RootMenu->AddMenuItem(23, "mi_ambildata_php", $Language->MenuPhrase("23", "MenuText"), "ambildata.php", -1, "", AllowListMenu('{D8E5AA29-C8A1-46A6-8DFF-08A223163C5D}ambildata.php'), FALSE, TRUE);
...
$RootMenu->AddMenuItem(20, "mi_tb_jurnal", $Language->MenuPhrase("20", "MenuText"), "tb_jurnallist.php", -1, "", AllowListMenu('{D8E5AA29-C8A1-46A6-8DFF-08A223163C5D}tb_jurnal'), FALSE, FALSE);
