...
//
// Table class for tb_anggota
//
class ctb_anggota extends cTable {
	var $anggota_id;
	var $no_anggota;
	var $nama;
	var $tgl_masuk;
	...
	function __construct() {
		...
		$this->TableVar = 'tb_anggota';
		$this->TableName = 'tb_anggota';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tb_anggota`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// anggota_id
		$this->anggota_id = new cField('tb_anggota', 'tb_anggota', 'x_anggota_id', 'anggota_id', '`anggota_id`', '`anggota_id`', 3, -1, FALSE, '`anggota_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// no_anggota
		$this->no_anggota = new cField('tb_anggota', 'tb_anggota', 'x_no_anggota', 'no_anggota', '`no_anggota`', '`no_anggota`', 200, -1, FALSE, '`no_anggota`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_anggota->Sortable = TRUE; // Allow sort
		$this->fields['no_anggota'] = &$this->no_anggota;

		// nama
		$this->nama = new cField('tb_anggota', 'tb_anggota', 'x_nama', 'nama', '`nama`', '`nama`', 200, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// alamat
		$this->alamat = new cField('tb_anggota', 'tb_anggota', 'x_alamat', 'alamat', '`alamat`', '`alamat`', 200, -1, FALSE, '`alamat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->alamat->Sortable = TRUE; // Allow sort
		$this->fields['alamat'] = &$this->alamat;

		// kota
		$this->kota = new cField('tb_anggota', 'tb_anggota', 'x_kota', 'kota', '`kota`', '`kota`', 200, -1, FALSE, '`kota`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kota->Sortable = TRUE; // Allow sort
		$this->fields['kota'] = &$this->kota;

		// no_telp
		$this->no_telp = new cField('tb_anggota', 'tb_anggota', 'x_no_telp', 'no_telp', '`no_telp`', '`no_telp`', 200, -1, FALSE, '`no_telp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_telp->Sortable = TRUE; // Allow sort
		$this->fields['no_telp'] = &$this->no_telp;

		// pekerjaan
		$this->pekerjaan = new cField('tb_anggota', 'tb_anggota', 'x_pekerjaan', 'pekerjaan', '`pekerjaan`', '`pekerjaan`', 200, -1, FALSE, '`pekerjaan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pekerjaan->Sortable = TRUE; // Allow sort
		$this->fields['pekerjaan'] = &$this->pekerjaan;

		// jns_pengenal
		$this->jns_pengenal = new cField('tb_anggota', 'tb_anggota', 'x_jns_pengenal', 'jns_pengenal', '`jns_pengenal`', '`jns_pengenal`', 200, -1, FALSE, '`jns_pengenal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jns_pengenal->Sortable = TRUE; // Allow sort
		$this->fields['jns_pengenal'] = &$this->jns_pengenal;

		// no_pengenal
		$this->no_pengenal = new cField('tb_anggota', 'tb_anggota', 'x_no_pengenal', 'no_pengenal', '`no_pengenal`', '`no_pengenal`', 200, -1, FALSE, '`no_pengenal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`tb_anggota`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("tb_anggotaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("tb_anggotaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "tb_anggotaadd.php?" . $this->UrlParm($parm);
		else
			$url = "tb_anggotaadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("tb_anggotaedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("tb_anggotaadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tb_anggotadelete.php", $this->UrlParm());
	}
