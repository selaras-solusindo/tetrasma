	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($t_jurnal->akun_id->FldErrMsg()) ?>");
...
<input type="text" data-table="t_jurnal" data-field="x_akun_id" name="x_akun_id" id="x_akun_id" size="30" placeholder="<?php echo ew_HtmlEncode($t_jurnal->akun_id->getPlaceHolder()) ?>" value="<?php echo $t_jurnal->akun_id->EditValue ?>"<?php echo $t_jurnal->akun_id->EditAttributes() ?>>
</span>
