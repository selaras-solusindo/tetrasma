...
ftb_detaillist.Lists["x_akun_id"] = {"LinkField":"x_level4_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_nama_akun","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"view_akun_jurnal"};
...
<?php if ($tb_detail_list->TotalRecs > 0 || $tb_detail->CurrentAction == "gridedit") { ?>
